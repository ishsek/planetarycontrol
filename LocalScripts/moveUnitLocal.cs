...
public class moveUnitLocal : MonoBehaviour
{
    ...
    private PlayerControllerLocal myContrl;
    ...
    private drawNavLineLocal myNavLine;
        ...
        else if (Input.mousePosition != prevMousPos)
        {
            ...
            if ((Math.Abs(currentMousPos.x - prevMousPos.x) > minMouseChangeDist) || (Math.Abs(currentMousPos.y - prevMousPos.y) > minMouseChangeDist))
            {
                ...
                if (Physics.Raycast(ray, out hit))
                {
                    ...
                    {
                        myOutline.OutlineWidth = outlineWidth;
                        myOutline.OutlineColor = outlineHoverColor;
    ...
    public void InitializeMe()
    {
        ...
        enemiesController = GameObject.Find("EnemyAI").GetComponent<EnemyControllerAI>();
        ...
        myContrl = GetComponent<PlayerControllerLocal>();
        myNavLine = GetComponent<drawNavLineLocal>();
